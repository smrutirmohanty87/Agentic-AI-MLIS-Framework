...
test.describe('End-to-End Policy Creation', () => {
  test('should create Residential E&W policy with multiple products end-to-end', async ({ page }) => {
    test.setTimeout(120000);
    const caseRef = `E2E-MULTI-${Date.now()}`;
    ...
    // 4) Select 4 different products and click Proceed. Verify Step 2 Statements of Fact loads.
