...
test.describe('End-to-End Complete Flow - Commercial E&W', () => {
  test('should complete full commercial england and wales policy creation flow end-to-end', async ({ page }) => {
